...
for (let user of simpsons) {
    document.write(`<div>${user.name} -${user.surname} ${user.age}  ${user.info}  <img src="${user.photo}" alt="simpsons.">
          </div>`)
}
document.write(`</div>`)
...
for (let user of simpsons) {
    document.write(`
     ...
     <p>${user.info} </p>
     <img src="${user.photo}" alt="simpsons.">
         </div>`)
}
document.write(`</div>`)
    ...
    document.write('<div class="products-box">');
       for (const product of products)
       {
             document.write(`<div class="product-card">
                <h2> ${product.title} price - ${product.price} UAN </h2>
